          ...
          {textOnRight ? (
            <>
              ...
              >
                ...
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(12,11,10,0.06) 0%, transparent 40%)' }} aria-hidden="true" />
              </motion.div>
              ...
              <div>
                ...
                <motion.div className="w-8 h-[0.5px] bg-brand-black/[0.06] mt-8" initial={{ scaleX: 0, originX: 0 }} animate={isInView ? { scaleX: 1 } : {}} transition={{ duration: 1, delay: 0.8, ease: [0.22, 1, 0.36, 1] }} aria-hidden="true" />
              </div>
            </>
          ) : (
            <>
